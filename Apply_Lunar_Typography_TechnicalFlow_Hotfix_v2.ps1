...
Step "Repo: $repoRoot"
Step "v2: reserved PowerShell variables avoided; safe after partial v1 execution."
...
$homeSource = Replace-Regex $homeSource 'className="absolute inset-y-\[4%\] right-0 w-\[92%\] overflow-hidden \[border-bottom-left-radius:[^"]+"' 'className="absolute inset-y-[3%] right-[-4%] w-[104%] overflow-visible lg:w-[106%]"'
$homeSource = Replace-Regex $homeSource 'className="absolute inset-y-\[3%\] right-\[-4%\] w-\[104%\] overflow-hidden [^"]+"' 'className="absolute inset-y-[3%] right-[-4%] w-[104%] overflow-visible lg:w-[106%]"'
$homeSource = Replace-Literal $homeSource '<TechnicalArc className="bottom-[-5%] left-[20%] hidden h-[360px] w-[520px] rotate-[11deg] lg:block" />' '<TechnicalArc label="FIELD / STRUCTURE" className="bottom-[-2%] left-[17%] hidden h-[340px] w-[560px] rotate-[5deg] lg:block" />'
$homeSource = Replace-Literal $homeSource '<TechnicalArc className="left-[25%] top-[14%] h-[500px] w-[520px] rotate-[30deg] opacity-65" />' '<TechnicalArc label="SHOP / DETAIL" className="left-[23%] top-[17%] h-[420px] w-[560px] rotate-[18deg] opacity-70" />'

# Section numbering creates an actual editorial information system instead of loose labels.
# Exact MicroLabel replacements keep this safe to run more than once.
$homeSource = Replace-Literal $homeSource '<MicroLabel>General contracting / field coordination</MicroLabel>' '<MicroLabel>01 / General contracting / field coordination</MicroLabel>'
$homeSource = Replace-Literal $homeSource '<MicroLabel>Capabilities / field package</MicroLabel>' '<MicroLabel>02 / Capabilities / field package</MicroLabel>'
$homeSource = Replace-Literal $homeSource '<MicroLabel>Selected work / project register</MicroLabel>' '<MicroLabel>03 / Selected work / project register</MicroLabel>'
$homeSource = Replace-Literal $homeSource '<MicroLabel>Site sequence / work logic</MicroLabel>' '<MicroLabel>04 / Site sequence / work logic</MicroLabel>'
$homeSource = Replace-Literal $homeSource '<MicroLabel>Control / tolerance / handover</MicroLabel>' '<MicroLabel>05 / Control / tolerance / handover</MicroLabel>'
$homeSource = Replace-Literal $homeSource '<MicroLabel>Field crew / personnel</MicroLabel>' '<MicroLabel>06 / Field crew / personnel</MicroLabel>'
$homeSource = Replace-Literal $homeSource '<MicroLabel>Field memo / client record</MicroLabel>' '<MicroLabel>07 / Field memo / client record</MicroLabel>'
$homeSource = Replace-Literal $homeSource '<MicroLabel>Closing note / next project</MicroLabel>' '<MicroLabel>08 / Closing note / next project</MicroLabel>'
...
foreach ($spec in $pageSpecs) {
  ...
  # Prefix the first micro-label once. Re-runs must not create A-01 / A-01 / ...
  if ($content -notmatch ([regex]::Escape('<MicroLabel>' + $spec.Prefix))) {
