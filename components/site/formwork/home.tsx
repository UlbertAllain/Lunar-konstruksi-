...
function metric(value: string, label: string) {
  return (
    <div className="min-w-[92px]">
      <p
        className={`${displayFont} text-[30px] font-black leading-none tracking-[-.03em] text-[#182d4d] sm:text-[34px]`}
      >
        {value}
      </p>
      <p className="mt-1 font-mono text-[8px] uppercase leading-4 tracking-[.12em] text-[#657184]">
        {label}
      </p>
    </div>
  );
      ...
      <main>
            ...
            <div className="relative z-20 flex flex-col justify-between px-4 pb-8 pt-10 sm:px-8 sm:pb-10 sm:pt-14 lg:px-10 lg:py-20">
              <div className="max-w-[610px]">
                <div className="flex items-center gap-3">
                  ...
                  <MicroLabel>
                    01 / Jasa konstruksi / renovasi / Solo Raya
                  </MicroLabel>
                </div>

                <h1
                  className={`${displayFont} mt-9 text-[clamp(2.35rem,10.5vw,4.8rem)] font-black uppercase leading-[0.87] tracking-[-0.05em] text-[#14243f]`}
                >
                  Kami membangun dari dasar yang jelas.
                </h1>

                <p className="mt-7 max-w-[470px] text-[15px] leading-8 text-[#5d6877]">
                  Lunar Konstruksi menangani konstruksi, renovasi, interior, dan
                  kebutuhan bangunan di Solo Raya. Dari perencanaan sampai
                  pekerjaan selesai, setiap tahap kami susun agar keputusan
                  lebih jelas dan pekerjaan tetap terarah.
                </p>
            ...
            <div className="relative min-h-[330px] sm:min-h-[470px] lg:min-h-full">
              ...
              <div className="absolute right-[4%] top-[14%] z-20 hidden w-[188px] -rotate-[3deg] border border-[#ded5c7] bg-[#faf7f0]/95 px-4 py-3.5 shadow-[0_18px_44px_rgba(20,36,63,0.10)] lg:block">
                ...
                <p className="mt-3 text-[11px] leading-5 text-[#596474]">
                  Perencanaan, urutan pekerjaan, dan kontrol lapangan kami susun
                  agar setiap keputusan mudah dipahami.
                </p>
              ...
              >
                <path
                  d="M12 205C102 248 160 74 286 124C394 167 415 245 520 182C591 140 611 65 688 89"
                  stroke="#dcb458"
                  strokeWidth="1.2"
                />
                <path
                  d="M18 220C105 260 171 91 292 140C394 181 432 249 530 198C598 161 626 88 694 104"
                  stroke="#182d4d"
                  strokeOpacity="0.2"
            ...
            <div className="grid gap-10 xl:grid-cols-[1.16fr_.84fr] xl:gap-16 xl:items-center">
                ...
                {featuredProject ? (
                  <div className="relative mt-7 sm:min-h-[570px]">
                    <Link
                      ...
                      style={{
                        clipPath:
                          "polygon(0% 0%,92% 0%,100% 10%,100% 88%,92% 100%,8% 100%,0% 90%)",
                      }}
                    >
                      <DatabaseImage
                    ...
                    {secondaryProjects[0] ? (
                      <Link
                        ...
                        style={{
                          clipPath:
                            "polygon(10% 0%,100% 0%,100% 90%,90% 100%,0% 100%,0% 14%)",
                        }}
                      >
                        <DatabaseImage
              ...
              <div className="xl:pl-4">
                <div className="border-t border-[#cfc8bd] pt-6">
                  ...
                  <h2
                    className={`${displayFont} mt-5 max-w-[520px] text-[clamp(2.25rem,3.35vw,3.45rem)] font-black uppercase leading-[.89] tracking-[-.04em] text-[#14243f]`}
                  >
                    Setiap proyek dibangun dari keputusan yang tepat.
                  </h2>
                  <p className="mt-6 max-w-lg text-[15px] leading-8 text-[#5f6976]">
                    Lihat beberapa pekerjaan yang telah kami tangani, lengkap
                    dengan lokasi, lingkup pekerjaan, dan dokumentasi hasilnya.
                  </p>

                  <Link
                    href="/projects"
                    className="mt-7 inline-flex items-center gap-3 border-b border-[#dcb458]/75 pb-2 font-black text-[10px] uppercase tracking-[.16em] text-[#14243f]"
                  >
                    Lihat semua proyek{" "}
                    <span className="h-px w-10 bg-[#dcb458]" />{" "}
                    <ArrowRight className="h-4 w-4 text-[#dcb458]" />
                  </Link>
                </div>
                ...
                <div className="mt-12 grid grid-cols-2 gap-4 border-y border-[#ddd5c8] py-5">
                  <div>
                    ...
                    <p className="mt-2 text-[12px] leading-6 text-[#5f6976]">
                      Setiap proyek ditampilkan untuk memberikan gambaran nyata
                      mengenai lingkup dan hasil pekerjaan kami.
                    </p>
                  </div>
                  <div>
                    <MicroLabel>Lihat proyek</MicroLabel>
                    <p className="mt-2 text-[12px] leading-6 text-[#5f6976]">
                      Lihat proyek lainnya untuk mengenal lebih jauh pengalaman
                      dan hasil pekerjaan Lunar Konstruksi.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="relative border-b border-[#d9d4ca] py-16 sm:py-20">
          <div className="mx-auto grid w-full max-w-[1480px] gap-10 px-5 sm:px-8 lg:grid-cols-[.66fr_.72fr_.62fr] lg:px-10">
            <div>
              ...
              <h2
                className={`${displayFont} mt-4 max-w-[430px] text-[clamp(2.15rem,3.15vw,3.25rem)] font-black uppercase leading-[.9] tracking-[-.035em]`}
              >
                Perencanaan yang siap diterapkan di lapangan.
              </h2>
              <p className="mt-5 max-w-sm text-sm leading-7 text-[#657184]">
                Empat tahap utama membantu setiap pekerjaan tetap terarah, dari
                kebutuhan awal sampai serah terima.
              </p>
            </div>
            ...
            <div className="relative sm:border-l sm:border-[#b8b1a7] sm:pl-7">
              {[
                [
                  "01",
                  "SURVEI",
                  "Kami memahami lokasi, kebutuhan, kondisi awal, dan hal penting yang perlu diperhatikan.",
                ],
                [
                  "02",
                  "PERENCANAAN",
                  "Desain, estimasi, material, dan kebutuhan teknis disusun dalam satu rencana kerja.",
                ],
                [
                  "03",
                  "PELAKSANAAN",
                  "Pekerjaan berjalan bersama kontrol mutu dan pemantauan perubahan di lapangan.",
                ],
                [
                  "04",
                  "SERAH TERIMA",
                  "Pekerjaan diperiksa kembali, dirapikan, dan disiapkan untuk proses serah terima.",
                ],
                ...
                <div key={number} className="relative pb-7 last:pb-0">
                  ...
                  <div className="flex items-baseline gap-3">
                    <span className={`${displayFont} text-xl font-black`}>
                      {number}
                    </span>
                    <span
                      className={`${displayFont} text-[1.05rem] font-black uppercase`}
                    >
                      {title}
                    </span>
                  </div>
                  <p className="mt-2 max-w-sm text-[13px] leading-6 text-[#657184]">
                    {text}
                  </p>
                </div>
              ))}
            ...
            <div className="grid content-start gap-4">
              <div className="lunar-public-page overflow-hidden [border-radius:42%_58%_52%_48%/48%_42%_58%_52%] border border-[#d9d4ca] bg-[#e6dfd3]">
                <DatabaseImage
                  src={processPrimary}
                  alt="Perencanaan dan koordinasi proyek"
                  className="aspect-[4/3] w-full object-cover"
                  placeholderLabel="Tambahkan gambar statis perencanaan"
                />
              </div>
              <div className="border-l-2 border-[#dcb458] bg-[#ece7df] p-4">
                <MicroLabel>Catatan lapangan / QC-04</MicroLabel>
                <p
                  className={`${displayFont} mt-3 max-w-[280px] text-[1.6rem] font-black uppercase leading-[.96]`}
                >
                  Keputusan teknis perlu tetap jelas dari awal sampai pekerjaan
                  selesai.
                </p>
              </div>
            </div>
        ...
        <section className="relative bg-[#f5f1e8] px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
          <div
            ...
            style={{
              borderRadius: "58px 150px 62px 130px / 50px 76px 54px 82px",
            }}
          >
            <svg
              aria-hidden="true"
              viewBox="0 0 1200 300"
              className="pointer-events-none absolute inset-x-0 bottom-0 h-[72%] w-full opacity-70"
              fill="none"
            >
              <path
                d="M-40 235C126 96 238 291 394 166C540 49 671 260 832 132C982 14 1078 198 1250 65"
                stroke="#dcb458"
                strokeWidth="1.25"
              />
              <path
                d="M-24 254C140 123 250 308 409 186C553 75 690 278 846 151C993 32 1096 216 1265 89"
            ...
            <div className="relative z-10 grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
              <div>
                <MicroLabel className="!text-[#dcb458]">
                  05 / Kontrol mutu / serah terima
                </MicroLabel>
                <h2
                  className={`${displayFont} mt-6 max-w-[670px] text-[clamp(2.2rem,3.3vw,3.4rem)] font-black uppercase leading-[0.88] tracking-[-0.045em] text-[#f8f4ec]`}
                >
                  Kontrol yang konsisten menjaga kualitas pekerjaan.
                </h2>
                <p className="mt-6 max-w-md text-[14px] leading-7 text-white/58">
                  Pengendalian mutu dilakukan sepanjang proyek untuk menjaga
                  pekerjaan tetap sesuai rencana dan mendukung proses serah
                  terima yang tertib.
                </p>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-3 lg:pb-2">
                {[
                  [
                    ...
                    "04",
                    "Pemeriksaan mutu",
                    "Keputusan mutu dicatat sebelum pekerjaan bergerak ke tahap berikutnya.",
                  ],
                  [
                    "INFO",
                    "12",
                    "Klarifikasi teknis",
                    "Pertanyaan teknis dibahas dan dicatat agar keputusan tidak membingungkan di lapangan.",
                  ],
                  [
                    "DONE",
                    "100%",
                    "Serah terima",
                    "Pekerjaan akhir diperiksa dan disiapkan agar proses serah terima lebih tertib.",
                  ],
                  ...
                  >
                    <div className="flex items-baseline justify-between gap-3">
                      <span className="text-[1.6rem] font-semibold tracking-[-0.04em] text-[#dcb458]">
                        {code}
                      </span>
                    ...
                    <p className="mt-5 text-[clamp(2.2rem,3.5vw,3.6rem)] font-semibold leading-none tracking-[-0.05em] text-white">
                      {value}
                    </p>
                    <p className="mt-4 text-[11px] leading-6 text-white/58">
                      {description}
                    </p>
                  </div>
                ))}
          ...
          <section className="relative border-b border-[#d9d4ca] py-14 sm:py-16">
            <div className="mx-auto grid w-full max-w-[1120px] gap-6 px-5 sm:px-8 lg:grid-cols-[100px_1fr_auto] lg:items-start lg:px-10">
              ...
              <div>
                ...
                <blockquote className="mt-4 max-w-3xl text-xl leading-[1.5] text-[#263b58] sm:text-2xl">
                  “{quote.quote}”
                </blockquote>
                <p className="mt-5 font-mono text-[8px] uppercase tracking-[.15em] text-[#dcb458]">
                  — {quote.name}
                  {quote.role ? ` / ${quote.role}` : ""}
                </p>
              </div>
              <div className="hidden border-l border-[#cfcac1] pl-5 font-mono text-[8px] uppercase leading-6 tracking-[.14em] text-[#848d99] lg:block">
                <span className="block">Record / TM-01</span>
                <span className="block">Status / Filed</span>
                <span className="block">Source / Client</span>
              </div>
            </div>
          </section>
        ) : null}
        ...
        <section className="relative py-14 sm:py-16">
          <div className="mx-auto grid w-full max-w-[1480px] gap-7 px-5 sm:px-8 lg:grid-cols-[1fr_auto] lg:items-end lg:px-10">
            <div>
              ...
              <h2
                className={`${displayFont} mt-4 max-w-[760px] text-[clamp(2.2rem,3.35vw,3.45rem)] font-black uppercase leading-[.88] tracking-[-.04em]`}
              >
                Wujudkan proyek Anda bersama Lunar Konstruksi.
              </h2>
              <p className="mt-4 max-w-xl text-sm leading-7 text-[#657184]">
                Ceritakan kebutuhan dan kondisi proyek Anda. Kami bantu
                menentukan langkah awal yang paling sesuai.
              </p>
            </div>
            <Link
              href="/contact"
              className="inline-flex items-center gap-4 border-b border-[#dcb458] pb-2 font-mono text-[9px] font-semibold uppercase tracking-[.12em]"
            >
