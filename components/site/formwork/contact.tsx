...
<TechnicalArc label="BRIEF / INTAKE" className="bottom-[-9%] left-[10%] h-[360px] w-[500px] rotate-[17deg]" /></div></div></section>
        ...
        <section className="relative py-20 sm:py-28"><div className="mx-auto grid w-full max-w-[1480px] gap-14 px-5 sm:px-8 lg:grid-cols-[.65fr_1.35fr] lg:px-10"><div><MicroLabel>Direct line / project desk</MicroLabel><h2 className={`${displayFont} mt-5 text-4xl font-black uppercase leading-[.92] sm:text-5xl lg:text-6xl`}>Bawa brief. Kami bantu merapikan langkah berikutnya.</h2><div className="mt-10 border-t border-[#c0bbb2] pt-5 font-mono text-[9px] uppercase leading-6 tracking-[.1em] text-[#707b8c]"><p>Email / {email}</p><p>Phone / {phone}</p><p>Availability / by appointment</p></div></div><div><MicroLabel>Project brief / required fields</MicroLabel><div className="mt-7"><TechnicalContactForm /></div></div></div></section>
