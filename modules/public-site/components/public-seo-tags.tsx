import type { SeoMetadata } from "../public-site.types";

export function PublicSeoTags({ metadata }: { metadata: SeoMetadata }) {
  const robots = [metadata.noIndex ? "noindex" : "index", metadata.noFollow ? "nofollow" : "follow"].join(", ");
  ...
  return (
    <>
      ...
      {metadata.ogImageUrl ? <meta property="og:image" content={metadata.ogImageUrl} /> : null}
